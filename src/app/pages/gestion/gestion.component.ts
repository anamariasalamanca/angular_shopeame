...
export class GestionComponent implements OnInit {
  ...
  constructor(private router:Router, private formBuilder: FormBuilder, public productServiceService:ProductServiceService) {
  ...
  onSubmit(){
    ...
    if (this.productForm.valid){
      ...
      this.productServiceService.postProduct(this.createdProduct).subscribe();
